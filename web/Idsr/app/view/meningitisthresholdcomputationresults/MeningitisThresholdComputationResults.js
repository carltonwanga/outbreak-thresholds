 ...
 */
Ext.define('Idsr.view.meningitisthresholdcomputationresults.MeningitisThresholdComputationResults', {
    extend: 'Ext.panel.Panel',

    requires: [
        'Ext.grid.column.Number',
        'Idsr.view.meningitisthresholdcomputationresults.MeningitisThresholdComputationResultsController',
        'Idsr.view.meningitisthresholdcomputationresults.MeningitisThresholdComputationResultsModel'
    ],
    xtype: 'meningitisthresholdcomputationresults',


    viewModel: {
        type: 'meningitisthresholdcomputationresults'
    },

    controller: 'meningitisthresholdcomputationresults',

    title: 'Meningitis Threshold Computation Results',
    height: 500,
    shrinkWrap: 0,
    layout: 'border',
    bodyPadding: 10,
                                    ...
                                    items:[
                                        {
                                            ...
                                            labelWidth: 75,
                                            pickerId:'menitcrSubCountyCombo',
                                            valueField: 'dhis2_code',
                                    ...
                                    items:[
                                        {
                                            ...
                                            labelWidth: 60,
                                            pickerId:'menitcrInferenceCombo',
                                            valueField: 'id',
