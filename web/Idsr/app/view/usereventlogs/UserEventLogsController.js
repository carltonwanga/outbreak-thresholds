 ...
 */
Ext.define('Idsr.view.usereventlogs.UserEventLogsController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.usereventlogs',
    ...
    onGenerateReport:function(){
        ...
        if(filterForm.isValid()){
            ...
            var reportUrl = Idsr.util.Constants.controllersApiFromIndex +"/audit/event/logs?"+filterValues;
    ...
    onResetFilters:function(){
        ...
        this.lookupReference('userFilter').reset();
    }
});