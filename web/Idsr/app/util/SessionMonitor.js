Ext.define('Idsr.util.SessionMonitor', {
    requires: [
    ...
    lastActive: null,
    maxInactive: 1000 * 60 * 10,  // 10 minutes of inactivity allowed; set it to 1 for testing.
    remaining: 0,
    ui: Ext.getBody(),
    ...
    window: Ext.create('Ext.window.Window', {
        ...
        items: [{
            xtype: 'container',
            frame: true,
            html: 'Your session automatically expires after 10 minutes of  inactivity. If your session expires, any unsaved data will be lost and  you will be automatically logged out. </br></br>If you want  to continue working, click the "Continue Working"  button.</br></br>'
        },{
            xtype: 'label',
            text: ''
        }],
        buttons: [{
            ...
            handler: function() {
                Ext.TaskManager.stop(Idsr.util.SessionMonitor.countDownTask);
                Idsr.util.SessionMonitor.window.hide();
